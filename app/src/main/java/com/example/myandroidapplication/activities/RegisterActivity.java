...
public class RegisterActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks {
    ...
    private void openSecondActivity(){
        ...
        sharedPreferenceMaster.setUserName(R_name.getText().toString().trim());
        sharedPreferenceMaster.setUserSurname(R_surname.getText().toString().trim());
        sharedPreferenceMaster.setUserCell(R_cellNo.getText().toString().trim());
        sharedPreferenceMaster.setUserAddress(R_address.getText().toString().trim());
